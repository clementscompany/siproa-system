    ...
    <div class="table-fatura">
        <header>
            ...
            <table class="dados-principais">
                <tr>
                    ...
                    <td style="font-weight:600;">Global Trading Lda</td>
                    <th>Req. Fundo Nº</th>
                    <td style="font-weight:600;">RF-8812</td>
                </tr>
        ...
        <table class="tabela-bloco">
            ...
            <tbody>
                ...
                <tr>
                    <td>9. Veterinário/Saúde</td>
                    <td>Kz</td>
                    <td>0,00</td>
                </tr>
                <tr>
                    <td>10. Validação do BL</td>
                    <td>Kz</td>
                    <td>1 003 380,39</td>
                </tr>
                <tr>
                    <td>11. Deslocação e Acompanhamento</td>
                    <td>Kz</td>
                    <td>140 000,00</td>
                </tr>
                <tr>
        ...
        <table class="tabela-bloco">
            ...
            <tbody>
                ...
                <tr>
                    <td>13. Licenciamento</td>
                    <td>Kz</td>
                    <td>20 000,00</td>
                </tr>
                <tr>
                    <td>14. Declaração de Valor</td>
                    <td>Kz</td>
                    <td>0,00</td>
                </tr>
                <tr>
