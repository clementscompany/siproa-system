export default function exportadores() {
  return (
    `
      <div class="cadastro-exportadores">
        ...
        <form id="exportersForm">
          ...
          <div class="form-group">
            <label for="nomeImportador">Nome do Exportador</label>
         ...
         <div class="form-group">
            <label for="nomeEntidade">Nome da Entendidade Angolana</label>
            <input type="text" id="nomeEntedidade" placeholder="Nome da Entidade">
         </div>

         <div class="form-group">
            <label for="nomeExportador">Número de Contribuinte (NIF)</label>
            <input type="text" id="nomeExportador" placeholder="NIF da Entidade">
         </div>
